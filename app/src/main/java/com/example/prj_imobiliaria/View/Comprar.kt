...
import com.example.prj_imobiliaria.View.Comprar.ApartamentosScreen
import com.example.prj_imobiliaria.View.Comprar.CasasScreen
import com.example.prj_imobiliaria.View.Comprar.TerrenosScreen


@Composable
fun ComprarScreen() {
    var tabIndex by remember { mutableStateOf(0) }
    val tabs = listOf("Casas", "Terrenos", "Apartamentos")
    ...
    Column(
        ...
        TabRow(
            ...
            tabs.forEachIndexed { index, title ->
                Tab(text = {
                    Text(
                        text = title, style = if (tabIndex == index) {
